...
def check_for_leakage(df1, df2, patient_col):
    ...
    leakage = (True if [value for value in df1_patients_unique                         if value in df2_patients_unique]                else False) # boolean (true if there is at least 1 patient in both groups)
